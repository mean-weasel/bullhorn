...
describe('IOSDateTimePicker mobile - handleConfirm', () => {
  beforeEach(() => {
    vi.clearAllMocks()
...
describe('IOSDateTimePicker mobile - handleConfirm - continued', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useIsMobile).mockReturnValue(true)
  })
...
describe('IOSDateTimePicker mobile - init and constraints', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useIsMobile).mockReturnValue(true)
  })
...
describe('IOSDateTimePicker mobile - preview', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useIsMobile).mockReturnValue(true)
  })
