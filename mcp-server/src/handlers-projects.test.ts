...
describe('Project Tool Handlers - create_project', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Project Tool Handlers - create_project - continued', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
  ...
  it('should trim the name', async () => {
    ...
    expect(mockPost).toHaveBeenCalledWith('/projects', expect.objectContaining({ name: 'Trimmed' }))
  })
})

describe('Project Tool Handlers - get_project', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Project Tool Handlers - update_project', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Project Tool Handlers - delete_project', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Project Tool Handlers - list_projects', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Project Tool Handlers - list_projects - continued', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
