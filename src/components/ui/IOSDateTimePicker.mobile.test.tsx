...
describe('IOSDateTimePicker mobile - rendering', () => {
  beforeEach(() => {
    vi.clearAllMocks()
...
describe('IOSDateTimePicker mobile - inputs', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useIsMobile).mockReturnValue(true)
  })
...
describe('IOSDateTimePicker mobile - dismiss', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useIsMobile).mockReturnValue(true)
  })
...
describe('IOSDateTimePicker mobile - handleClear', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useIsMobile).mockReturnValue(true)
  })
