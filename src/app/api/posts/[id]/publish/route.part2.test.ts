...
describe('POST /api/posts/[id]/publish (4/7)', () => {
...
describe('POST /api/posts/[id]/publish (5/7)', () => {
...
describe('POST /api/posts/[id]/publish (6/7)', () => {
...
describe('POST /api/posts/[id]/publish (7/7)', () => {
