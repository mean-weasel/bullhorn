...
describe('API Key Lifecycle E2E - Full-scope key', () => {
  beforeAll(async () => {
...
describe('API Key Lifecycle E2E - Full-scope key - continued', () => {
  beforeAll(async () => {
    // 1. Validate required env vars
    const sbAccessToken = process.env.SUPABASE_ACCESS_TOKEN
    if (!sbAccessToken) {
...
describe('API Key Lifecycle E2E - Scope enforcement', () => {
  beforeAll(async () => {
    // 1. Validate required env vars
    const sbAccessToken = process.env.SUPABASE_ACCESS_TOKEN
    if (!sbAccessToken) {
...
describe('API Key Lifecycle E2E - Scope enforcement - continued', () => {
  beforeAll(async () => {
    // 1. Validate required env vars
    const sbAccessToken = process.env.SUPABASE_ACCESS_TOKEN
    if (!sbAccessToken) {
...
describe('API Key Lifecycle E2E - Key expiration', () => {
  beforeAll(async () => {
    // 1. Validate required env vars
    const sbAccessToken = process.env.SUPABASE_ACCESS_TOKEN
    if (!sbAccessToken) {
