...
describe('Campaign Tool Handlers - create_campaign', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Campaign Tool Handlers - list_campaigns', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Campaign Tool Handlers - get_campaign', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Campaign Tool Handlers - delete_campaign', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Campaign Tool Handlers - add_post_to_campaign', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Campaign Tool Handlers - remove_post_from_campaign', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
