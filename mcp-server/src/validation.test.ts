...
describe('validatePostContent - twitter', () => {
...
describe('validatePostContent - linkedin', () => {
...
describe('validatePostContent - reddit', () => {
...
describe('validatePostContent - unknown platform', () => {
