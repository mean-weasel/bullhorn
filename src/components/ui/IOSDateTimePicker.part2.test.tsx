...
describe('IOSDateTimePicker (10/15)', () => {
  describe('mobile mode (4/9)', () => {
    describe('handleConfirm (1/3)', () => {
...
describe('IOSDateTimePicker (11/15)', () => {
  describe('mobile mode (5/9)', () => {
    describe('handleConfirm (2/3)', () => {
