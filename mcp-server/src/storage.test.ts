...
describe('Storage Layer (HTTP Client) - Post Operations', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Storage Layer (HTTP Client) - Post Operations - continued', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Storage Layer (HTTP Client) - Campaign Operations', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Storage Layer (HTTP Client) - Blog Draft Operations', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
...
describe('Storage Layer (HTTP Client) - Blog Draft Operations - continued', () => {
  beforeEach(() => {
    mockGet.mockReset()
    mockPost.mockReset()
    mockPatch.mockReset()
